...
| MCP server | `mcp-server/` | Node 18+ server exposing the same state directory through 22 MCP tools, including task classification, host model switch state, outcome loops, and parallel delegation (fanout). |
