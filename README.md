...
| MCP server | `mcp-server/` | Node 18+ server exposing the same state directory through 23 MCP tools, including task classification, host model switch state, provider probes, outcome loops, and parallel delegation (fanout). |
