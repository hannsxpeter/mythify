...
Current release target: `v3.6.32`.
...
- Version: `3.6.32`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.32.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.32.tgz`
...
```bash
gh release create v3.6.32 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.32.tgz \
  --title "Mythify v3.6.32" \
  --notes-file /tmp/mythify-v3-6-32-release-notes.md
```
...
(`mythify-mcp-3.6.32.tgz`) rather than publishing an npm package to the GitHub
