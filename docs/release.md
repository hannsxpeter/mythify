...
Current release target: `v3.6.29`.
...
- Version: `3.6.29`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.29.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.29.tgz`
...
```bash
gh release create v3.6.29 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.29.tgz \
  --title "Mythify v3.6.29" \
  --notes-file /tmp/mythify-v3-6-29-release-notes.md
```
...
(`mythify-mcp-3.6.29.tgz`) rather than publishing an npm package to the GitHub
