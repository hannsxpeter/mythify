...
Current release target: `v3.6.17`.
...
- Version: `3.6.17`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.17.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.17.tgz`
...
```bash
gh release create v3.6.17 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.17.tgz \
  --title "Mythify v3.6.17" \
  --notes-file /tmp/mythify-v3-6-17-release-notes.md
```
...
(`mythify-mcp-3.6.17.tgz`) rather than publishing an npm package to the GitHub
