...
Current release target: `v3.6.26`.
...
- Version: `3.6.26`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.26.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.26.tgz`
...
```bash
gh release create v3.6.26 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.26.tgz \
  --title "Mythify v3.6.26" \
  --notes-file /tmp/mythify-v3-6-26-release-notes.md
```
...
(`mythify-mcp-3.6.26.tgz`) rather than publishing an npm package to the GitHub
