...
- Version: `3.4.0`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.4.0.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.4.0.tgz`
...
gh release create v3.4.0 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.4.0.tgz \
  --title "Mythify v3.4.0" \
  --notes-file /tmp/mythify-v3-4-0-release-notes.md
```
...
(`mythify-mcp-3.4.0.tgz`) rather than publishing an npm package to the GitHub
