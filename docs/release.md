...
Current release target: `v3.6.21`.
...
- Version: `3.6.21`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.21.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.21.tgz`
...
```bash
gh release create v3.6.21 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.21.tgz \
  --title "Mythify v3.6.21" \
  --notes-file /tmp/mythify-v3-6-21-release-notes.md
```
...
(`mythify-mcp-3.6.21.tgz`) rather than publishing an npm package to the GitHub
