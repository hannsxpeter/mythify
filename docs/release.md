...
Current release target: `v3.6.47`.
...
- Version: `3.6.47`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.47.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.47.tgz`
...
```bash
gh release create v3.6.47 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.47.tgz \
  --title "Mythify v3.6.47" \
  --notes-file /tmp/mythify-v3-6-47-release-notes.md
```
...
(`mythify-mcp-3.6.47.tgz`) rather than publishing an npm package to the GitHub
