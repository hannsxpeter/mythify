...
Current release target: `v3.6.30`.
...
- Version: `3.6.30`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.30.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.30.tgz`
...
```bash
gh release create v3.6.30 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.30.tgz \
  --title "Mythify v3.6.30" \
  --notes-file /tmp/mythify-v3-6-30-release-notes.md
```
...
(`mythify-mcp-3.6.30.tgz`) rather than publishing an npm package to the GitHub
