...
Current release target: `v3.6.15`.
...
- Version: `3.6.15`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.15.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.15.tgz`
...
```bash
gh release create v3.6.15 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.15.tgz \
  --title "Mythify v3.6.15" \
  --notes-file /tmp/mythify-v3-6-15-release-notes.md
```
...
(`mythify-mcp-3.6.15.tgz`) rather than publishing an npm package to the GitHub
