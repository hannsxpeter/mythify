...
Current release target: `v3.6.20`.
...
- Version: `3.6.20`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.20.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.20.tgz`
...
```bash
gh release create v3.6.20 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.20.tgz \
  --title "Mythify v3.6.20" \
  --notes-file /tmp/mythify-v3-6-20-release-notes.md
```
...
(`mythify-mcp-3.6.20.tgz`) rather than publishing an npm package to the GitHub
