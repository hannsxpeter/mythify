...
Current release target: `v3.6.27`.
...
- Version: `3.6.27`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.27.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.27.tgz`
...
```bash
gh release create v3.6.27 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.27.tgz \
  --title "Mythify v3.6.27" \
  --notes-file /tmp/mythify-v3-6-27-release-notes.md
```
...
(`mythify-mcp-3.6.27.tgz`) rather than publishing an npm package to the GitHub
