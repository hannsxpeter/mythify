...
- Version: `5.3.0`
- Node runtime: `>=20`
- Package artifact: `mcp-server/mythify-mcp-5.3.0.tgz`
- Standalone CLI artifact: `dist/mythify-cli-5.3.0.tar.gz`
...
python3 scripts/package_cli.py --check-release-tag v5.3.0
...
cp dist/mythify.skill dist/mythify-cli-5.3.0.tar.gz \
  mcp-server/mythify-mcp-5.3.0.tgz dist/release-assets/
python3 scripts/build_release_checksums.py \
  --output dist/release-assets/SHA256SUMS \
  dist/release-assets/mythify.skill \
  dist/release-assets/mythify-cli-5.3.0.tar.gz \
  dist/release-assets/mythify-mcp-5.3.0.tgz
python3 scripts/build_release_checksums.py \
...
`npm install /path/to/mythify-mcp-5.3.0.tgz`; there is no registry publish.
...
(`mythify-mcp-5.3.0.tgz`) rather than publishing an npm package to the GitHub
