...
Current release target: `v3.6.28`.
...
- Version: `3.6.28`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.28.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.28.tgz`
...
```bash
gh release create v3.6.28 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.28.tgz \
  --title "Mythify v3.6.28" \
  --notes-file /tmp/mythify-v3-6-28-release-notes.md
```
...
(`mythify-mcp-3.6.28.tgz`) rather than publishing an npm package to the GitHub
