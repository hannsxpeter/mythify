...
- Version: `3.6.6`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.6.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.6.tgz`
...
gh release create v3.6.6 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.6.tgz \
  --title "Mythify v3.6.6" \
  --notes-file /tmp/mythify-v3-6-6-release-notes.md
```
...
(`mythify-mcp-3.6.6.tgz`) rather than publishing an npm package to the GitHub
