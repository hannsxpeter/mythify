...
Current release target: `v3.6.57`.
...
- Version: `3.6.57`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.57.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.57.tgz`
...
```bash
gh release create v3.6.57 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.57.tgz \
  --title "Mythify v3.6.57" \
  --notes-file /tmp/mythify-v3-6-57-release-notes.md
```
...
(`mythify-mcp-3.6.57.tgz`) rather than publishing an npm package to the GitHub
