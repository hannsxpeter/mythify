...
- Version: `3.6.4`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.4.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.4.tgz`
...
gh release create v3.6.4 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.4.tgz \
  --title "Mythify v3.6.4" \
  --notes-file /tmp/mythify-v3-6-4-release-notes.md
```
...
(`mythify-mcp-3.6.4.tgz`) rather than publishing an npm package to the GitHub
