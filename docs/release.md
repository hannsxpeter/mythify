...
Current release target: `v3.6.24`.
...
- Version: `3.6.24`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.24.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.24.tgz`
...
```bash
gh release create v3.6.24 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.24.tgz \
  --title "Mythify v3.6.24" \
  --notes-file /tmp/mythify-v3-6-24-release-notes.md
```
...
(`mythify-mcp-3.6.24.tgz`) rather than publishing an npm package to the GitHub
