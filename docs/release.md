...
- Version: `3.6.5`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.5.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.5.tgz`
...
```bash
gh release create v3.6.5 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.5.tgz \
  --title "Mythify v3.6.5" \
  --notes-file /tmp/mythify-v3-6-5-release-notes.md
```
...
(`mythify-mcp-3.6.5.tgz`) rather than publishing an npm package to the GitHub
