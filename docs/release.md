...
Current release target: `v3.6.45`.
...
- Version: `3.6.45`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.45.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.45.tgz`
...
```bash
gh release create v3.6.45 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.45.tgz \
  --title "Mythify v3.6.45" \
  --notes-file /tmp/mythify-v3-6-45-release-notes.md
```
...
(`mythify-mcp-3.6.45.tgz`) rather than publishing an npm package to the GitHub
