...
- Version: `4.2.0`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-4.2.0.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-4.2.0.tgz`
...
(`mythify-mcp-4.2.0.tgz`) rather than publishing an npm package to the GitHub
