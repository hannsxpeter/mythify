...
Current release target: `v3.6.39`.
...
- Version: `3.6.39`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.39.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.39.tgz`
...
```bash
gh release create v3.6.39 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.39.tgz \
  --title "Mythify v3.6.39" \
  --notes-file /tmp/mythify-v3-6-39-release-notes.md
```
...
(`mythify-mcp-3.6.39.tgz`) rather than publishing an npm package to the GitHub
