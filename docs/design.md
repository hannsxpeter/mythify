...
(current 1.x) and `zod` (4.x). package.json: name `mythify-mcp`, version `3.6.6`,
...
This is Mythify v3.6.6. Fanout was added in 2.1.0; 2.2.0 added local
...
classification and verification record-shape conformance coverage.
The CLI prints no version banner; the MCP server reports 3.6.6 through its
server info.
